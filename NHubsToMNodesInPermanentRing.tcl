...
## In reality, the link layer rate is 120 kbit/s and there are two 16 s connections possible in each direction each 40 s.
## From the network layer, this is equivalent to being able to transfer 120e3*16 bits on each direction full-duplex each 40 s.
...
Agent/Ping instproc recv {from rtt} {
	global ns num_pings_rx num_pings_tx maxrtt minrtt currsrcnode currdstnode last_arrival bp opt timeslot stoppingtime epsilon
	$self instvar node_
